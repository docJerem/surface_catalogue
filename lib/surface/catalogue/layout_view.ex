  ...
  def render(_, assigns) do
    ...
    <html lang="en">
      <head>
        ...
        <link phx-track-static rel="stylesheet" href={assets_file("ui_components.css")}>
        <script defer phx-track-static type="text/javascript" src={assets_file("ui_components.js")} />
